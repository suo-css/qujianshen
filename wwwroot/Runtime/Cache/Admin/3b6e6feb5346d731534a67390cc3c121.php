...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('type/add',array('action'=>ACTION_NAME));?>">新 增 </a>
           <button class="btn ajax-post confirm" url="<?php echo U('type/delete',array('table'=>ACTION_NAME));?>" target-form="ids">删 除</button>
        </div>
