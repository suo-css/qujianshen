...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('goal/goalcontinuetype_add',array('table'=>ACTION_NAME));?>">新 增 动 作</a>
            <button class="btn ajax-post confirm" url="<?php echo U('goal/delete',array('table'=>ACTION_NAME));?>" target-form="ids">删 除</button>
        </div>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="<?php echo U('Goal/goalcontinuetype_edit',array('id'=>$vo['id']));?>">修改</a>
				<a href="<?php echo U('Goal/delete',array('table'=>ACTION_NAME,'id'=>$vo['id']));?>" class="confirm ajax-get">删除</a>
				<a href="<?php echo U('Goal/setstatus',array('id'=>$vo['id'],'status'=>$vo['status'],'table'=>ACTION_NAME));?>" class="ajax-get"><?php $status = ($vo['status']==0) ? 启用 : 禁用; echo $status; ?></a>
			</td>
                </td>
