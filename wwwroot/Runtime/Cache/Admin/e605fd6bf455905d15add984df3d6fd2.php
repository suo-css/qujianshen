    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">适用性别<span class="check-tips">（不能为空）</span></label>
                    <select name="sex">
                            <?php $_result=get_sex_type(null, true);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
        </div>
        <div class="form-item">
            <label class="item-label">肌群类型<span class="check-tips">（不能为空）</span></label>
                    <select name="mainmuscletype">
                            <?php $_result=get_mainmuscletype(1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
        </div>
        <div class="form-item">
            <label class="item-label">锻炼类型<span class="check-tips">（不能为空）</span></label>
                    <select name="exercisetype">
                            <?php $_result=get_mainmuscletype(2);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
        </div>
        <div class="form-item">
            <label class="item-label">设备类型<span class="check-tips">（不能为空）</span></label>
                    <select name="equiptype">
                            <?php $_result=get_mainmuscletype(3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
        </div>
                <div class="form-item">
            <label class="item-label">力量形式<span class="check-tips">（不能为空）</span></label>
                    <select name="forcetype">
                            <?php $_result=get_mainmuscletype(4);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
        </div>
            ...
            <label class="item-label">运动<span class="check-tips">（不能为空）</span></label>
                    <select name="sport">
                            <?php $_result=get_mainmuscletype(5);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
        </div>
