...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Exercise/add');?>">新 增 动 作</a>
            <button class="btn ajax-post confirm" url="<?php echo U('Exercise/delete',array('table'=>Exercise,'uid'=>eid));?>" target-form="ids">删 除</button>
        </div>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><input class="ids" type="checkbox" name="id[]" value="<?php echo ($vo["eid"]); ?>" /></td>
			<td><?php echo ($vo["eid"]); ?> </td>
			<td><?php echo ($vo["ename"]); ?></td>
			<td><?php echo ($vo["sex"]); ?></td>
			<td><?php echo ($vo["rating"]); ?></td>
			<td>
				<a href="<?php echo U('Exercise/edit',array('id'=>$vo['eid']));?>">修改</a>
				<a href="<?php echo U('Exercise/delete',array('table'=>Exercise,'uid'=>eid,'id'=>$vo['eid']));?>" class="confirm ajax-get">删除</a>
				<a href="<?php echo U('Exercise/setstatus',array('id'=>$vo['eid'],'status'=>$vo['status']));?>" class="ajax-get"><?php $status = ($vo['status']==0) ? 禁用 : 启用; echo $status; ?></a>
			</td>
                </td>
	...
	<script src="/2/Public/static/thinkbox/jquery.thinkbox.js"></script>
